...
function M.render(vacancy_map)
  ...
  push(lines, "Diagnosis quality: " .. tostring(vacancy_map.diagnosis_quality or "unknown"))
  push(lines, "Likely hidden role: " .. tostring(vacancy_map.likely_hidden_role or "Role shape unclear"))
  push(lines, "")
  push(lines, "## Contract Warnings")
  push(lines, "")
  push_list(lines, vacancy_map.contract_warnings)
  push(lines, "")
